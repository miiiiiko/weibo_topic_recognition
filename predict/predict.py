...
class Multi_label:
    ...
    def predict(self, sents):
        ...
        with torch.no_grad():
            zz = ((self.model1(xs).detach().cpu()+self.model2(xs).detach().cpu())/2 > 0.5).float().cpu()
        ret = []
        for z in zz:
...
mfile1 = '/home/qsm22/weibo_topic_recognition/300base1cls.ckpt'
model1 = Model()
mfile2 = '/home/qsm22/weibo_topic_recognition/largebase1.ckpt'
model2 = Model_large()
