...
source = ljqpy.LoadJsons('datasets/train.json')
llist = sortlabel.TokenList('datasets/sortlabel.txt', source=source, func=lambda x:x['label'], low_freq=1, save_low_freq=1)
...
if __name__ == '__main__':
    ...
    mfile = 'models/largebase1e40.ckpt'
    ...
    dl_test = DataLoader(ds_test, batch_size=32, collate_fn=collate_fn)
    print("dataloader completed")
  
    print("finish loading model")
    # mfile = 'models/largebase1_1.ckpt'
    ...
    plot_learning_curve(record,'./models/largebase1e40.png')
    print('done')
