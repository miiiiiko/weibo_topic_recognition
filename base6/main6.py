...
def label_smoothing(targets, smoothing=0.1):
    # with torch.no_grad():targets不含参数，用不着no_grad吧
    targets = targets  * (1 - smoothing) + 0.5 * smoothing # 1变成0.95，0变成0.05
    return targets
...
if __name__ == '__main__':
    ...
    mfile = './output/base5/128base5_ls.pt'
    ...
    plot_learning_curve(record,'./output/base5/128_base5_ls')
    print('done')