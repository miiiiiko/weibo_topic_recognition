...
# base4仅产生句子向量，然后计算cosine相似度，不需要接线性层
class Model(nn.Module):
    def __init__(self, model_path='hfl/chinese-roberta-wwm-ext', encoder_type = 'cls'):
...
class Model_l(nn.Module):
    def __init__(self, model_path='hfl/chinese-roberta-wwm-ext-large',encoder_type = 'cls'):
